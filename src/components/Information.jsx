...
const Information = () => {
  return (
    <div className="max-w-[100vw] min-h-[75vh] bg-dark font-plusUltra flex flex-col items-center gap-10 justify-around p-10">
      <div className="flex flex-row  w-full justify-around max-md:flex-col max-md:gap-5">
        <p className="text-white text-4xl font-semibold w-[40%]  max-md:w-full ">
          Se lo ponemos fácil a <span className="text-secundary">inquilinos </span> y
          <span className="text-secundary"> propietarios.</span>
        </p>

        <p className="text-white text-[14px] opacity-60 w-[25%] ">
      ...
      <div className="flex flex-row  w-full justify-around gap-5 overflow-x-auto py-2 max-w-[80vw] ">
        <CardInformation
          icon={
      ...
      <div className="flex flex-row justify-around w-1/2 h-fit">
        <span className="flex flex-col items-center gap-1">
          <p className="text-white font-bold text-4xl ">7.4%</p>
        ...
        <span className="flex flex-col items-center">
          <p className="text-white font-bold text-4xl">3,856</p>
          <p className="text-white opacity-40 text-xs">Propiedad en Venta y Alquiler</p>
        </span>
        <span className="w-1 bg-white h-10 gap-1"></span>
        <span className="flex flex-col items-center">
          <p className="text-white font-bold text-4xl">2,540</p>
